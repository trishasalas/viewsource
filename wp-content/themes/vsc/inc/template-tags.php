...
function the_posts_navigation() {
	...
	<nav class="navigation posts-navigation" role="navigation">
		...
		<div class="nav-links">
			...
			<div class="nav-previous"><?php next_posts_link( esc_html__( 'Older posts', '_sophie_' ) ); ?></div>
			<?php endif; ?>

			<?php if ( get_previous_posts_link() ) : ?>
			<div class="nav-next"><?php previous_posts_link( esc_html__( 'Newer posts', '_sophie_' ) ); ?></div>
			<?php endif; ?>
...
function _sophie__posted_on() {
	...
	$posted_on = sprintf(
		esc_html_x( 'Posted on %s', 'post date', '_sophie_' ),
		'<a href="' . esc_url( get_permalink() ) . '" rel="bookmark">' . $time_string . '</a>'
	);

	$byline = sprintf(
		esc_html_x( 'by %s', 'post author', '_sophie_' ),
...
add_action( 'save_post',     '_sophie__category_transient_flusher' );
	...
	function viewsource_venue_google_map() {
		?>
		<section id="location" class="map" style="height: 400px;width: 100%;">
